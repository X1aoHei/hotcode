...
import { extractMethodSignatures, formatJavaCode } from '@/utils/code'
...
async function handleFormatDraft() {
  if (!form.value.draft.trim()) return
  form.value.draft = await formatJavaCode(form.value.draft)
            ...
            <div v-show="activeTab === 'code'" class="form-section">
              <div class="field field--full">
                <div class="field-label-row">
                  ...
                  <button class="auto-btn" @click="handleFormatCode">格式化代码</button>
                </div>
              ...
              <div class="field field--full">
                <div class="field-label-row">
                  ...
                  <div class="label-actions">
                    ...
                    <button class="auto-btn" @click="handleFormatDraft">格式化代码</button>
                  </div>
                </div>
                <div class="editor-wrap">
                  <Codemirror
